...
Tests and coverage were not supplied. No benchmark results were provided. Backup behavior was not specified. No extra modules were identified. Manual verification was not supplied. Comment handling was not specified.`;
    const outcome = runRequirements(response, commitRequirements, {
      artifactText: response,
      taskClass: "commit",
    });
